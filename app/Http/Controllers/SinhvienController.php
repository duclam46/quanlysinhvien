...
class SinhvienController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect() -> route('sinhvien.index') -> with('thongbao', 'Sinh viên đã được thêm thành công.');
    }
    ...
    public function update(Request $request, Sinhvien $sinhvien)
    {
        ...
        return redirect() -> route('sinhvien.index') -> with('thongbao', 'Sinh viên đã được cập nhật thành công.');
    }
    ...
    {
        $sinhvien -> delete();
        return redirect() -> route('sinhvien.index') -> with('thongbao', 'Sinh viên đã được xóa thành công.');
    }
}
